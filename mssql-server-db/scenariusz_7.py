...
# Wywołanie skryptu
# python scenariusz_7.py -dbconf X -dset Y
#   -dbconf X
...
# dataset1
results_filename = 'scenariusz_7_zestaw_danych_1.csv'

if args.dataset == 2:
    # dataset2
    results_filename = 'scenariusz_7_zestaw_danych_2.csv'
elif args.dataset == 3:
    # dataset3
    results_filename = 'scenariusz_7_zestaw_danych_3.csv'
elif args.dataset == 4:
    # dataset4
    results_filename = 'scenariusz_7_zestaw_danych_4.csv'
...
stmt = "SELECT TOP 100 * FROM title " \
...
print('Scenariusz 7')
print('Opis: ')
print('Wybór danych z tabeli title z pojedynczym warunkiem (zastosowanie klauzuli WHERE) '
      '- wybierane są rekordy, w których kolumna title_type_id jest równa 1 (title_type_id = 1), '
      'są to wszystkie tytuły, które są filmami (movie). '
      'Zbiór wynikowy posortowano (zastosowanie klauzuli ORDER BY) po kolumnie id rosnąco (ASC). '
      'Nałożony został również limit (zastosowanie klauzuli TOP), zwracanych jest tylko 100 rekordów z tabeli.')
