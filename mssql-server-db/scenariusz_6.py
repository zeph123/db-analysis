...
# Wywołanie skryptu
# python scenariusz_6.py -dbconf X -dset Y
#   -dbconf X
...
# dataset1
results_filename = 'scenariusz_6_zestaw_danych_1.csv'

if args.dataset == 2:
    # dataset2
    results_filename = 'scenariusz_6_zestaw_danych_2.csv'
elif args.dataset == 3:
    # dataset3
    results_filename = 'scenariusz_6_zestaw_danych_3.csv'
elif args.dataset == 4:
    # dataset4
    results_filename = 'scenariusz_6_zestaw_danych_4.csv'
...
print('Scenariusz 6')
print('Opis: ')
print('Wybór danych z tabeli title bez żadnych warunków (filtrów). '
      'Zbiór wynikowy posortowano (zastosowanie klauzuli ORDER BY) po kolumnie id rosnąco (ASC). '
      'Nałożony został jedynie limit (zastosowanie klauzuli TOP), zwracanych jest tylko 100 rekordów z tabeli.')
