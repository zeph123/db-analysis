...
title_scenario_1['forAdults'] = title_scenario_1['forAdults'].apply(lambda x: bool(int(x)))
...
title['forAdults'] = title['forAdults'].apply(lambda x: bool(int(x)))
...
title.to_sql('title', con=engine, schema='public', if_exists='append', index=False, method='multi', chunksize=data_chunksize)
